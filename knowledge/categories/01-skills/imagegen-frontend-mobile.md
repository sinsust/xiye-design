...
- **替代**：`imagegen-frontend-web`（网页端出图）、`image-to-code`（图转代码）。在线同主题的"以真实参考图锚定设计"开源技能是 [codeswithroh/tastemaker](https://github.com/codeswithroh/tastemaker)（公开参考，非本技能本体）。
