...
export const SOURCE_FILES: Record<string, string[]> = {
  ...
  "outstand-all": [],
  "wexo-all": ["wexo/index.html"],
  "genius-all": ["genius/index.html"],
  "genius-index": ["genius/index.html"],
  "genius-blogs": ["genius/blogs.html"],
  "genius-changelog": ["genius/changelog.html"],
  "genius-contact": ["genius/contact.html"],
  "genius-privacy": ["genius/privacy-policy.html"],
  "genius-waitlist": ["genius/waitlist.html"],
};
...
export const COMPONENT_LIB: LibraryComponent[] = [
  ...
  },
  {
    ...
    name: "Outstand 全部",
    icon: "Globe",
    description: "Outstand 完整站点：深色高质感 Agency 官网（Next.js 项目源码，含首页/关于/服务/作品/联系等多页面路由）。",
    category: "整站模板",
    site: "Outstand",
    settings: [],
  },
  ...
  // ===== Wexo 整站模板（Originkit Framer 导出，按 data-framer-name 拆为 12 独立区块）=====
  {
    ...
    name: "Wexo 全部",
    icon: "Globe",
    description: "Wexo 完整站点：iframe 嵌入 Originkit 原版 index.html，保留全部页面跳转与动效（与品牌包下载同源）。",
    category: "整站模板",
    site: "Wexo",
    settings: [],
  },
  ...
  // ===== Genius 整站模板（Originkit 静态站，index/blogs/changelog/contact/privacy/waitlist 六个页面）=====
  {
    id: "genius-all",
    name: "Genius 全部",
    icon: "Globe",
    description: "Genius 完整站点：iframe 嵌入 Originkit 原版 index.html，首页 + 博客/变更日志/联系/隐私/等待列表多页可点击（与品牌包下载同源）。",
    category: "整站模板",
    site: "Genius",
    settings: [],
  },
  {
    ...
    name: "Genius 首页",
    icon: "Sparkles",
    description: "Genius 产品落地首页：导航 + Hero + 特性亮点 + 社会证明 + CTA + 页脚（Originkit 原版静态站，CSS 动效忠实还原）。",
    category: "整站模板",
    site: "Genius",
    settings: [],
  },
  {
    ...
    name: "Genius 博客",
    icon: "Sparkles",
    description: "Genius 博客列表与文章页：卡片网格 + 封面/标题/摘要/日期，含单篇正文（Originkit 原版静态站）。",
    category: "整站模板",
    site: "Genius",
    settings: [],
  },
  {
    ...
    name: "Genius 更新日志",
    icon: "Sparkles",
    description: "Genius 更新日志页：版本时间线 + 变更说明，深色极简排版（Originkit 原版静态站）。",
    category: "整站模板",
    site: "Genius",
    settings: [],
  },
  {
    ...
    name: "Genius 联系页",
    icon: "Sparkles",
    description: "Genius 联系页：表单 + 联系信息 + 地图占位，深色主题（Originkit 原版静态站）。",
    category: "整站模板",
    site: "Genius",
    settings: [],
  },
  {
    ...
    name: "Genius 隐私政策",
    icon: "Sparkles",
    description: "Genius 隐私政策页：分节长文，法律条款排版（Originkit 原版静态站）。",
    category: "整站模板",
    site: "Genius",
    settings: [],
  },
  {
    ...
    name: "Genius 等候名单",
    icon: "Sparkles",
    description: "Genius 等候名单页：邮箱订阅 + 社交证明，转化导向落地页（Originkit 原版静态站）。",
    category: "整站模板",
    site: "Genius",
    settings: [],
  },
