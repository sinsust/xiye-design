              ...
              <div className={styles.subContainer2} data-border="true">
                <div className={styles.icon}>
                  <div className={styles.r6}>
                    <Image className={styles.r7} src="/assets/media/alurETgX7LlRhCOuHGL6QCmQzQ.svg" alt="Icon" width={20} height={21} />
                  </div>
                </div>
                  ...
                  <div className={`${styles.arrowContainer} ${styles.onlyDesktop}`}>
                    <div className={styles.iconWrap}>
                      <div className={styles.icon3}>
                        <div className={styles.r6}>
                          <Image className={styles.r50} src="/assets/media/o8sUeIHyFUmZSNFjpn4ePKPB9DY.svg" alt="" width={21} height={20} aria-hidden="true" />
                        </div>
                      </div>
                    ...
                    <div className={styles.iconWrap2}>
                      <div className={styles.icon6}>
                        <div className={styles.r64}>
                          <Image className={styles.r65} src="/assets/media/o8sUeIHyFUmZSNFjpn4ePKPB9DY.svg" alt="" width={21} height={20} aria-hidden="true" />
                        </div>
                      </div>
                ...
                <a className={styles.big} data-border="true" href="https://www.facebook.com/" target="_blank" rel="noreferrer">
                  <div className={`${styles.container4} ${styles.onlyDesktop}`}>
                    <div className={styles.iconContainer} data-border="true">
                      <div className={styles.icon2}>
                        <div className={styles.r41}>
                          <Image className={styles.r42} src="/assets/media/24iKj0UJV2woUKu6kGEcrZfF2g.svg" alt="Facebook Logo" width={24} height={24} />
                        </div>
                      </div>
                    </div>
                    <div className={styles.textContainer2}>
                  ...
                  <div className={`${styles.container5} ${styles.onlyTablet}`}>
                    <div className={styles.iconContainer2} data-border="true">
                      <div className={styles.icon5}>
                        <div className={styles.r55}>
                          <Image className={styles.r56} src="/assets/media/24iKj0UJV2woUKu6kGEcrZfF2g.svg" alt="Facebook Logo" width={24} height={24} />
                        </div>
                      </div>
                    </div>
                    <div className={styles.textContainer3}>
                  ...
                  <div className={`${styles.container6} ${styles.onlyPhone}`}>
                    <div className={styles.iconContainer3} data-border="true">
                      <div className={styles.icon8}>
                        <div className={styles.r70}>
                          <Image className={styles.r71} src="/assets/media/24iKj0UJV2woUKu6kGEcrZfF2g.svg" alt="Facebook Logo" width={24} height={24} />
                        </div>
                      </div>
                    </div>
                  </div>
