              ...
              <div className={styles.textContainer}>
                ...
                <div className={styles.paragraph}>
                  <p className={styles.r14}>
                    Dive into our diverse range of categories to find the perfect solutions for your business needs. Whether you&apos;re looking for web design, SEO, or branding, we&apos;ve got you covered.
                  </p>
                </div>
              </div>
            </div>
