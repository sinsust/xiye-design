...
// auth/... 路由分发器：把 6 个原 route.ts 合并为 1 个 Serverless Function。
// URL 与行为保持不变；仅用于满足 Vercel Hobby 12 函数上限。
import { NextRequest, NextResponse } from "next/server";
import * as m0 from "@/lib/api-handlers/auth/login";
import * as m1 from "@/lib/api-handlers/auth/logout";
import * as m2 from "@/lib/api-handlers/auth/me";
import * as m3 from "@/lib/api-handlers/auth/register";
...
const ROUTES: RouteDef[] = [
  { key: "login", methods: { POST: m0.POST as HandlerFn } },
  { key: "logout", methods: { POST: m1.POST as HandlerFn } },
  { key: "me", methods: { GET: m2.GET as HandlerFn } },
  { key: "register", methods: { POST: m3.POST as HandlerFn } },
