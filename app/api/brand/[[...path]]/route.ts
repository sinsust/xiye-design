...
// brand/... 路由分发器：把 3 个原 route.ts 合并为 1 个 Serverless Function。
// URL 与行为保持不变；仅用于满足 Vercel Hobby 12 函数上限。
import { NextRequest, NextResponse } from "next/server";
import * as m0 from "@/lib/api-handlers/brand/export-wexo";
import * as m1 from "@/lib/api-handlers/brand/rewrite";
import * as m2 from "@/lib/api-handlers/brand/zip";
...
const ROUTES: RouteDef[] = [
  { key: "export-wexo", methods: { POST: m0.POST as HandlerFn } },
  { key: "rewrite", methods: { POST: m1.POST as HandlerFn } },
  { key: "zip", methods: { GET: m2.GET as HandlerFn, POST: m2.POST as HandlerFn } },
];
