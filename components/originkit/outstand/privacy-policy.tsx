        ...
        <div className={styles.r1}>
          <div className={styles.background}>
            <div className={styles.r3}>
              <picture>
                <source media="(max-width: 809px)" srcSet="/originkit/outstand/privacy-policy/uxAzcI3QNmENiDSVZe9GOKaIi0.png" />
                <source media="(max-width: 1319px)" srcSet="/originkit/outstand/privacy-policy/wOjky7G3ggdUU3ZD2OnncXU9A8.png" />
                <img className={styles.r4} src="/originkit/outstand/privacy-policy/lE2RV4iTSTCJH3TNr5bnJkEOa8.png" alt="Hero Background" width={1440} height={1269} loading="lazy" decoding="async" />
              </picture>
            </div>
          </div>
        </div>
            ...
            <div className={styles.container2} data-border="true">
              <div className={styles.icon}>
                <div className={styles.r18}>
                  <img className={styles.r19} src="/originkit/outstand/privacy-policy/yG8AFadFqhY2Dgkb8ijRb3zrxyQ.svg" alt="Icon" width={21} height={20} />
                </div>
              </div>
