              ...
              <div className={styles.tag} data-border="true">
                <div className={styles.icon}>
                  <div className={styles.r6}>
                    <img className={styles.r7} src="/originkit/outstand/about/kXzKnSo8AYBBiRWPv9cmra68Z38.svg" alt="Icon" width={20} height={20} />
                  </div>
                </div>
            ...
            <div className={styles.r1}>
              <div className={styles.image}>
                <div className={styles.r18}>
                  <img className={styles.r19} src="/originkit/outstand/about/cLYzyomAKkuIY6hVgkscLfTmpQ.jpg" alt="About Us Image" width={545} height={363} />
                </div>
              </div>
            </div>
          </div>
