              ...
              <div className={styles.tag} data-border="true">
                <div className={styles.icon}>
                  <div className={styles.r6}>
                    <img className={styles.r7} src="/originkit/outstand/contact-support/HF8M5tPq0nwy3do9DLOgTcr1f2g.svg" alt="Icon" width={20} height={20} />
                  </div>
                </div>
              ...
              <div className={styles.subContainer2}>
                <div className={styles.icon2}>
                  <div className={styles.r20}>
                    <img className={styles.r21} src="/originkit/outstand/contact-support/AjRSp79fx1LPv4e4B1KlsLtdEZc.svg" alt="Icon" width={24} height={24} />
                  </div>
                </div>
              ...
              <div className={styles.r26}>
                <a className={styles.hoverArrow} data-border="true" href="#">
                  ...
                  <div className={styles.iconRight}>
                    <div className={styles.icon}>
                      <div className={styles.r6}>
                        <img className={styles.r31} src="/originkit/outstand/contact-support/lJSvGFGPhRLFfxcyPg1nppxYdA.svg" alt="" width={20} height={20} aria-hidden="true" />
                      </div>
                    </div>
                  </div>
                </a>
          ...
          <div className={styles.card2} data-border="true">
            <div className={styles.container2}>
              <div className={styles.subContainer3}>
                <div className={styles.icon2}>
                  <div className={styles.r20}>
                    <img className={styles.r35} src="/originkit/outstand/contact-support/JTpykLKaHYU0B6cgqBPTa5MAoM.svg" alt="Icon" width={25} height={24} />
                  </div>
                </div>
            ...
            <div className={styles.r1}>
              <div className={styles.r40}>
                <a className={styles.hoverArrow2} data-border="true" href="#">
                  <div className={styles.text2}>
                    <p className={styles.r29}>
                      Get in Touch
                    </p>
          ...
          <div className={styles.card} data-border="true">
            <div className={styles.container}>
              <div className={styles.subContainer4}>
                <div className={styles.icon2}>
                  <div className={styles.r20}>
                    <img className={styles.r35} src="/originkit/outstand/contact-support/2txGmcOBXehPQnYosck02lNP5DM.svg" alt="Icon" width={25} height={24} />
                  </div>
                </div>
                <div className={styles.heading2}>
                  <h3 className={styles.r23}>
