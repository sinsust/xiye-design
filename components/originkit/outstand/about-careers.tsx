...
// next/image stripped
import styles from './about-careers.module.css';
              ...
              <div className={styles.tag} data-border="true">
                <div className={styles.icon}>
                  <div className={styles.r6}>
                    <img className={styles.r7} src="/originkit/outstand/about-careers/zpPFJWGaV8uPaBugMXDbdfE00.svg" alt="Icon" width={20} height={20} />
                  </div>
                </div>
              ...
              <div className={styles.textContainer}>
                ...
                <div className={styles.paragraph}>
                  <p className={styles.r14}>
                    Join our team of digital experts and be part of a dynamic agency dedicated to innovation and excellence.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className={styles.iconContainer} data-border="true">
                    <div className={styles.iconWrap}>
                      <div className={styles.icon2}>
                        <div className={styles.r6}>
                          <img className={styles.r27} src="/originkit/outstand/about-careers/o8sUeIHyFUmZSNFjpn4ePKPB9DY.svg" alt="Icon" width={21} height={20} />
                        </div>
                      </div>
