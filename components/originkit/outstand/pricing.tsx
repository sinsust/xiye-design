              ...
              <div className={styles.tag} data-border="true">
                <div className={styles.icon}>
                  <div className={styles.r6}>
                    <img className={styles.r7} src="/originkit/outstand/pricing/FFqNUcSsgkVR6pPcSidAiBgL8.svg" alt="Icon" width={20} height={20} />
                  </div>
                </div>
                ...
                <div className={styles.abstractDesign}>
                  ...
                  <div className={styles.design}>
                    <div className={styles.r28}>
                      <img className={styles.r29} src="/originkit/outstand/pricing/f0JiZEf5UFSnsTGx0XVn3jcB5s.svg" alt="Design Image" width={52} height={40} />
                    </div>
                  </div>
                  <div className={styles.design2}>
                    <div className={styles.r31}>
                      <img className={styles.r32} src="/originkit/outstand/pricing/NwxZKIsJvtFCFMFxK2Xgq9pVjAg.svg" alt="Design Image" width={11} height={12} />
                    </div>
                  </div>
                </div>
              </div>
                        ...
                        <div className={styles.iconWrap}>
                          <div className={styles.icon2}>
                            <div className={styles.r51}>
                              <img className={styles.r52} src="/originkit/outstand/pricing/EwgbXikcCY3tz44KnCvHTil6Uk.svg" alt="Tick Icon" width={18} height={18} />
                            </div>
                          </div>
                        </div>
                  ...
                  <div className={styles.r55}>
                    <a className={styles.hoverArrow} data-border="true" href="#">
                      ...
                      <div className={styles.iconRight}>
                        <div className={styles.icon}>
                          <div className={styles.r6}>
                            <img className={styles.r60} src="/originkit/outstand/pricing/lJSvGFGPhRLFfxcyPg1nppxYdA.svg" alt="" width={20} height={20} aria-hidden="true" />
                          </div>
                        </div>
                      </div>
                    </a>
                    ...
                    <div className={styles.container3}>
                      ...
                      <div className={styles.frame856} data-border="true">
                        <div className={styles.icon3}>
                          <div className={styles.r6}>
                            <img className={styles.r68} src="/originkit/outstand/pricing/ydUiyw6aFLrc1G7eEVXiBsr8u0.svg" alt="Icon" width={21} height={21} />
                          </div>
                        </div>
                      ...
                      <div className={styles.iconRight2}>
                        <div className={styles.icon4}>
                          <div className={styles.r89}>
                            <img className={styles.r90} src="/originkit/outstand/pricing/Z4EozQtdVmroG1HDLS4zKFJeGo.svg" alt="Icon" width={20} height={20} />
                          </div>
                        </div>
                      </div>
