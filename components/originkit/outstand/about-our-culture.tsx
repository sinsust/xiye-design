...
// next/image stripped
import styles from './about-our-culture.module.css';
              ...
              <div className={styles.tag} data-border="true">
                <div className={styles.icon}>
                  <div className={styles.r6}>
                    <img className={styles.r7} src="/originkit/outstand/about-our-culture/6k6txB4lPzOUCSkGFkVFMcgWM.svg" alt="Icon" width={21} height={20} />
                  </div>
                </div>
          ...
          <div className={styles.r1}>
            <div className={styles.image}>
              <div className={styles.r17}>
                <img className={styles.r18} src="/originkit/outstand/about-our-culture/OCS2Ox5LMu9TtQeC47uk6aFIS7w.png" alt="Our Culture Image" width={435} height={532} />
              </div>
            </div>
          </div>
            ...
            <div className={styles.subContainer2}>
                ...
                <div className={styles.r1}>
                  <div className={styles.icon2}>
                    <div className={styles.r23}>
                      <img className={styles.r24} src="/originkit/outstand/about-our-culture/5Pg2xBESngkXyyRoWs1FuSczzfY.svg" alt="Icon" width={28} height={28} />
                    </div>
                  </div>
                </div>
              ...
              <div className={styles.card2}>
                <div className={styles.r1}>
                  <div className={styles.icon2}>
                    <div className={styles.r23}>
                      <img className={styles.r24} src="/originkit/outstand/about-our-culture/Sm1SNKYiZ3Ij7jgxK0UgLJXHg.svg" alt="Icon" width={28} height={28} />
                    </div>
                  </div>
                </div>
            ...
            <div className={styles.subContainer2}>
              <div className={styles.card2}>
                <div className={styles.r1}>
                  <div className={styles.icon2}>
                    <div className={styles.r23}>
                      <img className={styles.r24} src="/originkit/outstand/about-our-culture/2OVkMdemouSMWKOLPKlsY1EVQg.svg" alt="Icon" width={28} height={28} />
                    </div>
                  </div>
                </div>
                <div className={styles.textContainer3}>
              ...
              <div className={styles.card2}>
                <div className={styles.r1}>
                  <div className={styles.icon2}>
                    <div className={styles.r23}>
                      <img className={styles.r24} src="/originkit/outstand/about-our-culture/wWMvWk1dkHCOuBiKnpba5bsOQQ.svg" alt="Icon" width={28} height={28} />
                    </div>
                  </div>
                </div>
                <div className={styles.textContainer3}>
